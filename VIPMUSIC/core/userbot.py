...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("MEHFIL_YE_KHAYALAT")
                await self.two.join_chat("MEHFIL_YE_KHAYALAT")
                await self.two.join_chat("MEHFIL_YE_KHAYALAT")
                await self.two.join_chat("MEHFIL_YE_KHAYALAT")
            except:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("MEHFIL_YE_KHAYALAT")
                await self.three.join_chat("MEHFIL_YE_KHAYALAT")
                await self.three.join_chat("MEHFIL_YE_KHAYALAT")
                await self.three.join_chat("MEHFIL_YE_KHAYALAT")
            except:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("MEHFIL_YE_KHAYALAT")
                await self.four.join_chat("MEHFIL_YE_KHAYALAT")
                await self.four.join_chat("MEHFIL_YE_KHAYALAT")
                await self.four.join_chat("MEHFIL_YE_KHAYALAT")
            except:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("MEHFIL_YE_KHAYALAT")
                await self.five.join_chat("MEHFIL_YE_KHAYALAT")
                await self.five.join_chat("MEHFIL_YE_KHAYALAT")
                await self.five.join_chat("MEHFIL_YE_KHAYALAT")
            except:
