...
def first_page(_):
	controll_button = [InlineKeyboardButton(text="ᴍᴇɴᴜ", callback_data=f"settingsback_helper"), InlineKeyboardButton(text="﹥", callback_data=f"dilXaditi")]
	first_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_6"], callback_data="help_callback hb6"), InlineKeyboardButton(text=_["H_B_10"], callback_data="help_callback hb10")],[InlineKeyboardButton(text=_["H_B_11"], callback_data="help_callback hb11")],
...
def second_page(_):
	controll_button = [InlineKeyboardButton(text="﹤", callback_data=f"settings_back_helper")]
	second_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_18"], callback_data="help_callback hb18"), InlineKeyboardButton(text=_["H_B_13"], callback_data="help_callback hb13")],[InlineKeyboardButton(text=_["H_B_21"], callback_data="help_callback hb21")],
